 ...
 * El logo usa `currentColor`, así sigue al acento del despliegue (VITE_COLOR_ACENTO);
...
export function Marca({ className = '' }: { className?: string }) {
  return (
    <span className={`inline-flex min-w-0 items-center gap-2 text-acento ${className}`}>
