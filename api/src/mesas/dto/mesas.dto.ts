...
export class SnapshotMesasDto implements SnapshotMesas {
  ...
  @ApiProperty({
    ...
    description:
      ...
      'PROVISIONAL que lee el panel (F1-050; SUPUESTO, esquema-sr.md §5, la valida F1-023): ' +
      ...
      'total, modificadores: [{ nombre, precio }] }] }`. Un campo ausente o ilegible se ' +
      'muestra como "Sin dato".',
  })
