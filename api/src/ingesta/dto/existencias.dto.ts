...
export class RegistroExistenciaDto {
  ...
  @ApiProperty({
    ...
    example: '85.40',
    description:
      'Costo promedio por unidad con que se valúa esta fila, sin IVA supuesto. En SR es por ' +
      'insumo y empresa, no por almacén: el agente repite el mismo en cada almacén de la ' +
      'empresa (esquema-sr §10). Regla de ' +
